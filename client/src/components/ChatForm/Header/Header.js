...
import {ChatHeader, ChatHeaderAvatar, Media, UlChatHeaderOptions} from "./StyledHeader";
...
const Header = (props) => {
   ...
   return (
      <ChatHeader>
         ...
         <UlChatHeaderOptions>
            <a href=""><LiTag ptd="8px" plr="6px" w="1.25rem" h="1.25rem"><BsSearch /></LiTag></a>
            <a href="" onClick={props.onClickVideoCall}><LiTag ptd="8px" plr="6px" w="1.25rem" h="1.25rem"><BsTelephone /></LiTag></a>
